      ...
      <div class="col-md-4 col-xs-12 col-sm-12">
          ...
          <center>
            <i class="material-icons">flash_auto</i>
              ...
              <p class="text-center">Login to your Artisan account</p>
              <form method="POST" action="/login">
                {{ csrf_field() }}
                <div class="form-group">
                  <input type="text" name="usr_email" class="form-control" placeholder="Enter your Email or Username" value="{{ old('usr_email') }}" required>
                  ...
                  <div class="form-group">
                    <span style="color: #555555">remember me</span>
                    <input type="checkbox" name="remember" class="pull-right" id="remember">
                  </div>
                  <p class="text-right"><a href="/password/reset">Forgot password ?</a></p>
                  
                  <button type="sumbit" class="btn btn-primary btn-group-justified">Get Started</button>
        ...
        {{ csrf_field() }}
          <div class="form-group">
            <div class="container-fluid">
              ...
              <div>
                <input class="form-control input" name="username" placeholder="Userame" type="text" value="{{ old('username') }}" required id="reg_usrn"/>
